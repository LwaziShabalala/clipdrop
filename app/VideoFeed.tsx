...
function FeedCard({ video }: { video: VideoRecord }) {
  ...
  return (
    <div
      ...
      style={{
        // Sized by HEIGHT first (capped to the viewport), width derives from
        // the 9:16 ratio — this is the YouTube Shorts approach. Sizing by
        // width instead (letting height fall out of the ratio) is what was
        // making the card taller than the screen, pushing the overlaid
        // title/account below the fold.
        height: "min(calc(100dvh - 150px), 780px)",
        width: "auto",
        maxWidth: 420,
        aspectRatio: "9 / 16",
      }}

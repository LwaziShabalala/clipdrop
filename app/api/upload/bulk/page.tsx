...
export default function BulkUploadPage() {
    ...
    // Uploads one file via the exact same /api/upload endpoint the regular
    // single-upload page uses — no backend changes needed for bulk upload,
    // this just calls it multiple times, one at a time.
    ...
    const startBulkUpload = async () => {
        setStage("uploading");
        // Sequential on purpose — uploading many at once would mean several
        // ffmpeg/thumbnail jobs competing for the server at the same time.
